...
var _user$project$Shared$maxsize = 7;
var _user$project$Shared$minsize = 1;
var _user$project$Shared_ops = _user$project$Shared_ops || {};
_user$project$Shared_ops['?++'] = F2(
	function (list, mby) {
		var _p0 = mby;
		if (_p0.ctor === 'Just') {
			return A2(
...
var _user$project$Position$asTuple = function (_p0) {
	var _p1 = _p0;
...
var _user$project$Position$position = F2(
	function (x, y) {
		return ((_elm_lang$core$Native_Utils.cmp(x, _user$project$Shared$minsize) < 0) || ((_elm_lang$core$Native_Utils.cmp(x, _user$project$Shared$maxsize) > 0) || ((_elm_lang$core$Native_Utils.cmp(y, _user$project$Shared$minsize) < 0) || (_elm_lang$core$Native_Utils.cmp(y, _user$project$Shared$maxsize) > 0)))) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
			A2(_user$project$Position$Position, x, y));
	});
var _user$project$Position$move = F3(
	function (x2, y2, _p2) {
		var _p3 = _p2;
		return A2(_user$project$Position$position, _p3._0 + x2, _p3._1 + y2);
	});

var _user$project$Tuple3$third = function (_p0) {
	var _p1 = _p0;
	return _p1._2;
};
var _user$project$Tuple3$second = function (_p2) {
	var _p3 = _p2;
	return _p3._1;
};
var _user$project$Tuple3$first = function (_p4) {
	var _p5 = _p4;
	return _p5._0;
};

var _user$project$Main$tile = function (color) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('square relative'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'-light border-',
									A2(_elm_lang$core$Basics_ops['++'], color, '-dark'))))),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _user$project$Main$positionStyle = function (pos) {
	var toPercent = function (i) {
		return _elm_lang$core$Basics$toString((i - 1) * 100);
	};
	var _p0 = _user$project$Position$asTuple(pos);
	var x = _p0._0;
	var y = _p0._1;
...
var _user$project$Main$aim = F2(
	function (canMove, pos) {
		var _p1 = canMove ? {ctor: '_Tuple2', _0: 'yellow', _1: 'transition-fast'} : {ctor: '_Tuple2', _0: 'red', _1: 'transition'};
		var color = _p1._0;
		var transition = _p1._1;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'pin-t square absolute w-full z-30 ', transition)),
				_1: {
					ctor: '::',
					_0: _user$project$Main$positionStyle(pos),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$player = function (pos) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('pin-t square absolute w-full z-20 transition'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$positionStyle(pos),
				_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fadein absolute pin square rounded-full border-2 border-b-8 bg-green-light border-green-dark'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
	...
	function (enemies, player) {
		return A2(
			...
			A2(
				...
				function (_p2) {
					return _elm_lang$core$Maybe$Just(
						_user$project$Tuple3$first(_p2));
				},
				enemies));
	});
var _user$project$Main$getPosFromDir = function (dir) {
	var _p3 = dir;
	switch (_p3.ctor) {
		case 'Up':
			return A2(_user$project$Position$move, 0, -1);
		case 'Down':
			return A2(_user$project$Position$move, 0, 1);
		case 'Left':
			return A2(_user$project$Position$move, -1, 0);
		default:
			return A2(_user$project$Position$move, 1, 0);
	}
};
var _user$project$Main$aimPosition = function (model) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		_user$project$Main$getPosFromDir(model.aim),
		model.player);
};
var _user$project$Main$moveEnemy = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._1;
	return A2(
		_elm_lang$core$Maybe$map,
		function (pos) {
			return {ctor: '_Tuple3', _0: pos, _1: _p6, _2: _p5._2};
		},
		A2(_user$project$Main$getPosFromDir, _p6, _p5._0));
};
var _user$project$Main$enemy = function (_p7) {
	var _p8 = _p7;
	return A2(
		F2(
			function (v0, v1) {
		...
		A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'square absolute w-full z-10 transition', _1: true},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'fadeout',
								_1: _elm_community$maybe_extra$Maybe_Extra$isNothing(
									_user$project$Main$moveEnemy(_p8))
							},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Main$positionStyle(_p8._0),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fadein absolute pin rounded-sm border-2 border-b-8 bg-red-light border-red-dark'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _user$project$Main$onMove = function (model) {
	return (model.playerCanMove && _elm_community$maybe_extra$Maybe_Extra$isJust(
		_user$project$Main$aimPosition(model))) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			playerCanMove: false,
			player: A2(
...
var _user$project$Main$ifSpaceDown = F3(
	function (keyCode, ifSpace, $default) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Char$fromCode(keyCode),
			_elm_lang$core$Native_Utils.chr(' ')) ? ifSpace : $default;
	});
var _user$project$Main$saveHighscore = _elm_lang$core$Native_Platform.outgoingPort(
	'saveHighscore',
	function (v) {
		return v;
	});
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {state: a, player: b, playerCanMove: c, aim: d, score: e, highscore: f, enemies: g};
	});
var _user$project$Main$Respawnable = {ctor: 'Respawnable'};
	...
	var keyedAim = A2(
		...
		function (_p9) {
			return A2(
				...
				'aim',
				A2(_user$project$Main$aim, model.playerCanMove, _p9));
		},
		_user$project$Main$aimPosition(model));
	var keyedPlayer = A2(
		_elm_lang$core$Maybe$map,
		function (_p10) {
			return A2(
				...
				'player',
				_user$project$Main$player(_p10));
		},
		model.player);
	var tiles = function (i) {
		return A2(
			_elm_lang$core$List$repeat,
			i,
			_user$project$Main$tile('orange'));
	};
	var floorClasses = 'bg-grey-darker border-4 border-grey-darkest m-px';
	var floor = function (i) {
		return A2(
			_elm_lang$core$List$repeat,
			i,
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(floorClasses),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}));
	};
	var textClasses = 'text-center text-white uppercase text-shadow m-4';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'width m-auto px-2', _1: true},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'shake',
							_1: _elm_community$maybe_extra$Maybe_Extra$isNothing(model.player)
						},
						_1: {ctor: '[]'}
					}
				}),
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$h2,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], textClasses, ' text-5xl')),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class(
													A2(_elm_lang$core$Basics_ops['++'], floorClasses, ' absolute pin')),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {
											...
											_0: A3(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('absolute w-full'),
													_1: {ctor: '[]'}
												},
												A2(
													_user$project$Shared_ops['?++'],
													A2(
														_user$project$Shared_ops['?++'],
														A2(_elm_lang$core$List$map, _user$project$Main$enemy, model.enemies),
														keyedPlayer),
													keyedAim)),
											_1: {ctor: '[]'}
										}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								(!_elm_lang$core$Native_Utils.eq(model.state, _user$project$Main$Respawnable)) ? 'hidden' : ''),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(textClasses),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Tap or press space'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Main$CantRespawn = {ctor: 'CantRespawn'};
...
var _user$project$Main$init = {
	state: _user$project$Main$Respawnable,
	player: A2(_user$project$Position$position, 4, 4),
	playerCanMove: true,
	aim: _user$project$Main$Left,
	score: 0,
	highscore: 0,
	enemies: {ctor: '[]'}
};
...
var _user$project$Main$randomEnemy = function (key) {
	var toEnemy = F2(
		function (side, i) {
			var getEnemy = function (dir) {
				return _elm_lang$core$Maybe$map(
					function (pos) {
						return {ctor: '_Tuple3', _0: pos, _1: dir, _2: key};
					});
			};
			var _p11 = side;
			switch (_p11) {
				case 1:
					return A2(
						...
						A2(_user$project$Position$position, i, _user$project$Shared$minsize));
				case 2:
					return A2(
						getEnemy,
						_user$project$Main$Up,
						A2(_user$project$Position$position, i, _user$project$Shared$maxsize));
				case 3:
					return A2(
						getEnemy,
						_user$project$Main$Left,
						A2(_user$project$Position$position, _user$project$Shared$maxsize, i));
				default:
					return A2(
						getEnemy,
						_user$project$Main$Right,
						A2(_user$project$Position$position, _user$project$Shared$minsize, i));
			}
		});
	return A3(
		_elm_lang$core$Random$map2,
		...
		A2(_elm_lang$core$Random$int, _user$project$Shared$minsize, _user$project$Shared$maxsize));
};
var _user$project$Main$moveAim = function (aim) {
	var _p12 = aim;
	switch (_p12.ctor) {
		case 'Left':
...
var _user$project$Main$SetRespawnable = function (a) {
	return {ctor: 'SetRespawnable', _0: a};
};
...
var _user$project$Main$MoveAim = function (a) {
	return {ctor: 'MoveAim', _0: a};
};
var _user$project$Main$SpawnedEnemy = function (a) {
	return {ctor: 'SpawnedEnemy', _0: a};
};
var _user$project$Main$step = F2(
	function (msg, model) {
		var command = function () {
			var _p13 = msg;
			if (_p13.ctor === 'SpawnEnemy') {
				var nextKey = A3(
					...
					function (_p14) {
						return A2(
							...
							1,
							_user$project$Tuple3$third(_p14));
					},
					_elm_community$list_extra$List_Extra$last(model.enemies));
				return A2(
					_elm_lang$core$Random$generate,
					_user$project$Main$SpawnedEnemy,
					_user$project$Main$randomEnemy(nextKey));
			} else {
		...
		var nextModel = function () {
			...
			switch (_p15.ctor) {
				case 'MoveEnemies':
					var movedEnemies = _elm_community$maybe_extra$Maybe_Extra$values(
						A2(_elm_lang$core$List$map, _user$project$Main$moveEnemy, model.enemies));
					var despawnedEnemiesCount = _elm_lang$core$List$length(model.enemies) - _elm_lang$core$List$length(movedEnemies);
					return _elm_lang$core$Native_Utils.update(
						model,
						{enemies: movedEnemies, score: model.score + despawnedEnemiesCount});
				case 'SpawnEnemy':
					return model;
				case 'SpawnedEnemy':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							enemies: A2(_user$project$Shared_ops['?++'], model.enemies, _p15._0)
						});
				case 'MoveAim':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							playerCanMove: true,
							aim: _user$project$Main$moveAim(model.aim)
						});
				case 'KeyDown':
					return A3(
						_user$project$Main$ifSpaceDown,
						_p15._0,
						_user$project$Main$onMove(model),
						model);
				case 'MouseDown':
					return _user$project$Main$onMove(model);
				default:
					return model;
			}
		}();
		if (A2(_user$project$Main$checkCollision, nextModel.enemies, nextModel.player)) {
			var highscore = A2(_elm_lang$core$Basics$max, nextModel.score, nextModel.highscore);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					nextModel,
					{state: _user$project$Main$CantRespawn, highscore: highscore, player: _elm_lang$core$Maybe$Nothing}),
				_1: _user$project$Main$saveHighscore(highscore)
			};
		} else {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p16.ctor) {
			case 'Playing':
				return A2(_user$project$Main$step, msg, model);
			case 'CantRespawn':
				var _p17 = msg;
				if (_p17.ctor === 'SetRespawnable') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			default:
				var respawn = _elm_lang$core$Native_Utils.update(
					_user$project$Main$init,
					{state: _user$project$Main$Playing, highscore: model.highscore});
				var _p18 = msg;
				switch (_p18.ctor) {
					case 'MouseDown':
						return {ctor: '_Tuple2', _0: respawn, _1: _elm_lang$core$Platform_Cmd$none};
					case 'KeyDown':
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Main$ifSpaceDown, _p18._0, respawn, model),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Main$SpawnEnemy = function (a) {
	return {ctor: 'SpawnEnemy', _0: a};
};
var _user$project$Main$MoveEnemies = function (a) {
	return {ctor: 'MoveEnemies', _0: a};
};
	...
	var gameEvents = function () {
		...
		switch (_p21.ctor) {
			case 'Playing':
				return {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, 0.6 * _elm_lang$core$Time$second, _user$project$Main$MoveEnemies),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Time$every, 0.8 * _elm_lang$core$Time$second, _user$project$Main$SpawnEnemy),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$Time$every, 0.7 * _elm_lang$core$Time$second, _user$project$Main$MoveAim),
							_1: {ctor: '[]'}
						}
					}
				};
			case 'CantRespawn':
				return {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Main$SetRespawnable),
					_1: {ctor: '[]'}
				};
			default:
				return {ctor: '[]'};
